...
Display_Definition ada_feather_r1 = {
	...
	.lines = {
		...
		{ .x = 24, .y = 48, .string = "%4d", .value = &(_status_register_16_bit.ups_bat_voltage), .size = 2 },
		{ .x = 64+32, .y = 48, .string = "%4d", .value = &(_status_register_16_bit.vbus_voltage), .size = 2 },
		{ .x = 24, .y = 48 + 1*12, .string = "0x%02x", .value = &(_status_register_8bit.ups_state), .size = 1 },
		{ .x = 64+32, .y = 48 + 1*12, .string = "0x%02x", .value = &(ups_state_should_shutdown), .size = 1 },
		{ .x = 64, .y = 48 + 2*12, .string = "%05d", .value = &(_status_register_16_bit.seconds), .size = 2 },
	},
	.num_lines = 10,
};
...
Display_Definition ada_feather_r2 = {
	...
	.lines = {
		...
		{ .x = 32, .y = 10 + 1*12, .string = "%4d", .value = &(_status_register_16_bit.ups_bat_voltage), .size = 2 },
		{ .x = 32, .y = 10 + 3*12, .string = "%4d", .value = &(_status_register_16_bit.vbus_voltage), .size = 2 },
		{ .x = 32, .y = 10 + 5*12, .string = "0x%02x", .value = &(_status_register_8bit.ups_state), .size = 1 },
		{ .x = 32, .y = 10 + 7*12, .string = "0x%02x", .value = &(ups_state_should_shutdown), .size = 1 },
		{ .x = 32, .y = 10 + 9*12, .string = "%05d", .value = &(_status_register_16_bit.seconds), .size = 2 },
	},
	.num_lines = 10,
};
