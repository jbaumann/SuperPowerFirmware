 ...
 ******************************************************************************/
/*
 * Tracealizer configuration.
 *
 * For the Super Power project the selected streaming mode was selected with the ITM port 1
 * as the pin for the trace, the version of FreeRTOS is 10.3.1 and the trace capture
 * has only been tested with the ST-LINK v3
 */
